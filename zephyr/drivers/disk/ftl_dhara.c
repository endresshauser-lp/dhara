...
void dhara_nand_mark_bad(const struct dhara_nand *n, dhara_block_t b)
{
	...
	LOG_DBG("dhara_nand_mark_bad: block at 0x%X", b * ctx->block_size);
...
int dhara_nand_erase(const struct dhara_nand *n, dhara_block_t b, dhara_error_t *err)
{
	...
	LOG_DBG("dhara_nand_erase: block at 0x%X", b * ctx->block_size);
		    ...
		    dhara_error_t *err)
{
	...
	LOG_DBG("dhara_nand_prog: page at 0x%X", p * ctx->page_size);
...
int dhara_nand_is_free(const struct dhara_nand *n, dhara_page_t p)
{
	...
	LOG_DBG("dhara_nand_is_free: page at 0x%X", p * ctx->page_size);
		    ...
		    uint8_t *data, dhara_error_t *err)
{
	...
	LOG_DBG("dhara_nand_read: page at 0x%X", p * ctx->page_size);
		    ...
		    dhara_error_t *err)
{
	...
	LOG_DBG("dhara_nand_copy: 0x%X -> 0x%X", src * ctx->page_size, dst * ctx->page_size);
